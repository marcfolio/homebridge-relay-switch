...
module.exports = function(homebridge) {
  ...
  homebridge.registerAccessory('homebridge-relay-switch', 'RelaySwitch', RelayCmdAccessary);
};

function RelayCmdAccessary(log, config) {
  // this.log = log;
...
RelayCmdAccessary.prototype.setState = function(isClosed, callback, context) {
...
RelayCmdAccessary.prototype.getState = function(callback) {
//   var accessory = this;
...
RelayCmdAccessary.prototype.pollState = function() {
//   var accessory = this;
...
RelayCmdAccessary.prototype.getServices = function() {
